    ...
    Room[] check(API api1, API api2) {
        ...
        for (Room elementAr1 : api1.getAll()) {
            for (Room elementAr2 : api2.getAll()) {
                if (elementAr1.getPrice() == elementAr2.getPrice() &&
                        elementAr1.getPersons() == elementAr2.getPersons() &&
                        elementAr1.getHotelName() == elementAr2.getHotelName() &&
                        elementAr1.getCityName() == elementAr2.getCityName()) {
